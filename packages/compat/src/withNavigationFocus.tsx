...
>(
  ...
  type WrappedProps = Omit<Props, keyof NavigationFocusInjectedProps> &
    RefProps;
    ...
    C extends React.ComponentClass<any>
      ? C &
          React.ComponentClass<
            Omit<Props, keyof NavigationFocusInjectedProps> & RefProps
          >
      : // const Screen = React.memo(React.forwardRef((props, ref) => <></>));
      C extends React.MemoExoticComponent<React.ForwardRefExoticComponent<any>>
      ? WithStatics<
          React.MemoExoticComponent<
            (
              props: Omit<Props, keyof NavigationFocusInjectedProps> & RefProps
            ) => ReturnType<C>
          >
        >
      : // const Screen = React.memo((props) => <></>);
