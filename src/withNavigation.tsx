...
>(
  ...
  type NavigationComponentType
    ...
    // class Screen extends React.Component {}
    = C extends React.ComponentClass<any>
      ? WithStatics<React.ComponentClass<Omit<Props, keyof NavigationInjectedProps> & RefProps>>

    // const Screen = React.memo(React.forwardRef((props, ref) => <></>));
    : C extends React.MemoExoticComponent<React.ForwardRefExoticComponent<any>>
      ? WithStatics<React.MemoExoticComponent<(props: Omit<Props, keyof NavigationInjectedProps> & RefProps) => ReturnType<C>>>
    ...
    // const Screen = React.forwardRef((props, ref) => <></>);
    : C extends React.ForwardRefExoticComponent<any>
      ? WithStatics<React.ForwardRefExoticComponent<Omit<Props, keyof NavigationInjectedProps> & RefProps>>

    // const Screen = React.memo(((props, ref) => <></>) as React.FunctionComponent);
    : C extends React.NamedExoticComponent<any>
      ? WithStatics<React.NamedExoticComponent<(props: Omit<Props, keyof NavigationInjectedProps> & RefProps) => ReturnType<C>>>

    // const Screen = (props) => <></>;
    : C extends (props: any) => React.ReactElement | React.ReactNode | null | undefined
      ? WithStatics<(props: Omit<Props, keyof NavigationInjectedProps>) => ReturnType<C>>

    // const Screen: React.FunctionComponent = (props) => <></>;
    : C extends React.FunctionComponent<any>
      ? WithStatics<React.FunctionComponent<Omit<Props, keyof NavigationInjectedProps>>>
