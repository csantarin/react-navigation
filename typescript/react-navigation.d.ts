...
// re-export withNavigation* HOCs - rewires v4 to v5 until all occurrences can be replaced properly
// @todo: drop support for react-navigation v4 entirely
...
/**
 * Higher-order component that wraps an existing component with navigation functionality.
 *
 * @deprecated This module maps to React Navigation v5 compatibility layer. Please use that instead!
 *
 * @migration Use `@react-navigation/compat` instead of `react-navigtion`:
 *
 * ```ts
 * import { withNavigation } from '@react-navigation/compat';
 * ```
 */
export const withNavigation = Compat.withNavigation;
 ...
 * ```
 */
export const withNavigationFocus = Compat.withNavigationFocus;
