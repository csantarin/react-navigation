...
export declare function renderCompatNavigatorScreens<CreatedTypedNavigator extends TypedNavigator<ParamListBase, NavigationState, {}, any, React.ComponentType<any>>, NavigationPropType extends NavigationProp<any, any, any, any, any>, ParamList extends ParamListBase = NavigationPropType extends NavigationProp<infer P, any, any, any, any> ? P : ParamListBase, ScreenOptions extends {} = NavigationPropType extends NavigationProp<any, any, any, infer O> ? O : {}>(args: {
